...
class MediaInfoFactorySpec extends UnitSpec {
  ...
  "The getMediaInfo function" should "retrieve metadata of a h264 video from json strings" in {
  ...
  "The getMediaInfo function" should "retrieve metadata of a mpeg2 video from json strings" in {
  ...
  "The getMediaInfo function" should "retrieve metadata of a flv video from json strings" in {
